 ...
 * 
 */
public class ModelIndexerOriginalVisitor implements ReadableTypeVisitor {
  ...
  public static Pair<BasicDBObject, Map<String, String>> run(ReadableModel model) {
    ...
    ModelIndexerOriginalVisitor visitor = new ModelIndexerOriginalVisitor();
    visitor.visit(model);
    return Pair.<BasicDBObject, Map<String, String>> of(visitor.getDBObject(),
        visitor.getblipIdToPathMap());
  }

  protected ModelIndexerOriginalVisitor() {
