...
public interface WindowWrapper {
   ...
   * @param callback the prompt callback value
   */
  void prompt(String msg, String initialValue, WindowPromptCallback callback);
   ...
   *
   * @param msg the message to be displayed.
   * @param callback the boolean callback of the confirmation
   */
  void confirm(String msg, WindowConfirmCallback callback);
